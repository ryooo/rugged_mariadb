...
//{
//    printf(">> mysql_odb_backend__read_header\n");
...
//			git_odb_backend * _backend, const git_oid * oid)
//{
//    printf(">> mysql_odb_backend__read\n");
//	mysql_odb_backend *backend;
//	int error;
//	MYSQL_BIND bind_buffers[1];
...
//{
//    printf(">> mysql_odb_backend__exists\n");
//	mysql_odb_backend *backend;
//	int found;
//	MYSQL_BIND bind_buffers[1];
//
...
//{
//    printf(">> mysql_odb_backend__write\n");
//	int error;
//	mysql_odb_backend *backend;
...
//{
//    printf(">> mysql_odb_backend__free\n");
//	mysql_odb_backend *backend;
//	assert(_backend);
//	backend = (mysql_odb_backend *) _backend;
//
...
//            //printf("ERROR: mysql_host: %s\n", mysql_host);
//            printf("ERROR: mysql_user: %s\n", mysql_user);
//            printf("ERROR: mysql_passwd: ****\n");
//            printf("ERROR: mysql_db: %s\n", mysql_db);
//            printf("ERROR: mysql_port: %d\n", mysql_port);
//            if (mysql_unix_socket)
//                printf("ERROR: mysql_unix_socket: %s\n", mysql_unix_socket);
//            else
//                printf("ERROR: mysql_unix_socket: NULL\n");
//
...
//	if (error < 0) {
//		    printf("ERROR: init_db\n");
//		goto cleanup;
//	}
//
//	error = init_statements(backend);
//	if (error < 0) {
//		    printf("ERROR: init_statements\n");
//		goto cleanup;
//	}
//
...
//
// cleanup:
//    printf(">> ERROR: in git_odb_backend_mysql\n");
