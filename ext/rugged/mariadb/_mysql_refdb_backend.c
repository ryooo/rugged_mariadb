...
//{
//    printf(">> mysql_refdb_backend__exists\n");
...
//			    git_refdb_backend * _backend, const char *ref_name)
//{
//    printf(">> mysql_refdb_backend__lookup\n");
//	mysql_refdb_backend *backend = (mysql_refdb_backend *) _backend;
//	int error;
//
//	assert(backend);
...
//{
//    printf(">> mysql_refdb_backend__write\n");
//	mysql_refdb_backend *backend = (mysql_refdb_backend *) _backend;
//	int error;
...
//{
//    printf(">> mysql_refdb_backend__delete\n");
//	mysql_refdb_backend *backend = (mysql_refdb_backend *) _backend;
//	int error;
//	MYSQL_BIND bind_buffers[1];
//
...
//			    const git_signature * who, const char *message)
//{
//    printf(">> mysql_refdb_backend__rename\n");
//	mysql_refdb_backend *backend = (mysql_refdb_backend *) _backend;
...
//{
//    printf(">> mysql_refdb_backend__free\n");
//	mysql_refdb_backend *backend = (mysql_refdb_backend *) _backend;
//
//	assert(backend);
//
...
//            "  `refname` VARCHAR(" MAX_REFNAME_LEN_STR
//            ") NOT NULL,"
//            "  `target_oid` binary(20) NULL,"
//            "  `target_symbolic` VARCHAR(" MAX_REFNAME_LEN_STR
//            ") NULL,"
...
//{
//    printf(">> init_statements\n");
//	my_bool truth = 1;
//	static const char *sql_read =
//	    "SELECT target_oid FROM `" GIT2_REFDB_TABLE_NAME "` WHERE refname = ?;";
//
...
//            " (`refname`, `target_oid`, `target_symbolic`,"
//            " `peel_oid`)"
//            " VALUES (?, ?, ?, ?)"
//            " ON DUPLICATE KEY"
//            " UPDATE "
...
//{
//    printf(">> git_refdb_backend_mysql\n");
//	mysql_refdb_backend *backend;
//	my_bool reconnect = 1;
//
